...
/// <summary>Reports the largest number in a range.</summary>
[DisplayName("Max Range")]
[Description("Reports the largest number in a range.")]
public sealed class MaxRange : BaseActivity
{
