...
/// <summary>Reports the smallest number in a range.</summary>
[DisplayName("Min Range")]
[Description("Reports the smallest number in a range.")]
public sealed class MinRange : BaseActivity
{
