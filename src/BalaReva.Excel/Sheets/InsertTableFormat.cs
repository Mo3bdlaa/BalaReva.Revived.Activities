...
/// <summary>Applies a table style to a range.</summary>
[DisplayName("Insert Table Format")]
[Description("Applies a built-in or named table style to a range.")]
public sealed class InsertTableFormat : ExcelCore
{
    /// <summary>Range to style. Empty uses the whole used range.</summary>
    [Category("Input")]
    [DisplayName("Cell Range")]
    [Description("Range to style. Empty uses the whole used range.")]
